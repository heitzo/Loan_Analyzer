...
# Create a header using the keys in the dictionary 
header = ["loan_price", "remaining_months", "repayment_interval", "future_value"]
# Now remember to write the header row with the csvwriter.writerow(header) below
...
with open(csvpath, 'w', newline='') as csvfile:
    # 'w' lets us know we are writing a csv file from python to computer
    ...
    # after I open the CSV fil ein write mode, I  need to create csvwriter to write data to the file
    for loan in inexpensive_loans:
        # to write the data rows: iterate through inexpensive_loans (list of dictionaries) and the writerow function will extract the values and write the dictionary values as rows of data
        csvwriter.writerow(loan.values())

# running this will create a csv file named inexpensive_loans.csv
